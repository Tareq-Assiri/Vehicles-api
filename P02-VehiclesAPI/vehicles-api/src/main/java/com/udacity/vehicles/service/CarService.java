...
public class CarService {
    ...
    public Car findById(Long id) {
        ...
        if(c.isEmpty()){ throw new CarNotFoundException();}
    ...
    public Car save(Car car) {
        ...
        savedCar.setPrice(priceClient.getPrice(car.getId()));
        return savedCar;
    ...
    public void delete(Long id) {
        if (repository.findById(id).isEmpty()){throw new CarNotFoundException();}
